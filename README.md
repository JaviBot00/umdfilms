...
│   ├── index.html              ← listado completo (NUEVO)
...
│
├── artists/
│   └── index.html              ← Representación de Artistas (NUEVO)
│
├── css/
